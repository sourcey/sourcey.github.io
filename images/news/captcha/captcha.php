...
function captcha($config = array()) {
    ...
    $captcha_config = array(
        ...
        'min_length' => 5,
        'max_length' => 5,
	'png_backgrounds' => array(BASE_DIR . '/images/captcha/default.png'),
	'fonts' => array(BASE_DIR . '/images/captcha/times_new_yorker.ttf'),
    ...
    // Generate image src
    $image_src = substr(__FILE__, strlen(BASE_DIR)) . '?_CAPTCHA&amp;t=' . urlencode(microtime());
